...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"HkgTuningAngleSmoothingFactor", {PERSISTENT | BACKUP, INT, "6"}},
    {"HkgTuningAngleMinTorque", {PERSISTENT | BACKUP, INT, "25"}},
    {"HkgTuningAngleMaxTorque", {PERSISTENT | BACKUP, INT, "250"}},
    {"AngleTuning", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"CcncAdjacentVehicleDisplay", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CcncHdpDisplay", {PERSISTENT | BACKUP, BOOL, "0"}},
